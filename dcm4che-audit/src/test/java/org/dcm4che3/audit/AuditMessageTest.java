...
public class AuditMessageTest {
    ...
    public void testDICOMInstancesTransferred() throws Exception {
        BuildEventIdentification eventIdentification = new BuildEventIdentification.Builder(AuditMessages.EventID.DICOMInstancesTransferred,
        ...
        BuildParticipantObjectIdentification studyParticipant = new BuildParticipantObjectIdentification.Builder("1.2.840.10008.2.3.4.5.6.7.78.8",
        ...
        BuildParticipantObjectIdentification patientParticipant = new BuildParticipantObjectIdentification.Builder("ptid12345",
        ...
        AuditMessage msg = AuditMessages.createMessage(eventIdentification, activeParticipants, studyParticipant, patientParticipant);
